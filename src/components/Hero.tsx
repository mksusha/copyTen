                ...
                <div
                        ...
                        {!showVideo ? (
                            <button
                                ...
                                className="bg-emerald-500 hover:bg-emerald-600 text-white p-5 sm:p-6 md:p-6 rounded-full shadow-lg flex items-center justify-center"
                            ...
                            <iframe
                                ...
                                src="https://rutube.ru/play/embed/your-video-id/"
                                title="Демонстрация робота"
                                frameBorder="0"
