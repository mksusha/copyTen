...
//                         </div>
//                         <div>
//                             <p className="text-yellow-500 font-bold text-2xl">98%</p>
...
const screenshots = [
    { src: "/r1.jpg", alt: "Кейс 1" },
    { src: "/r2.jpg", alt: "Кейс 2" },
    { src: "/r3.jpg", alt: "Кейс 3" },
    { src: "/r4.jpg", alt: "Кейс 4" },
    { src: "/r5.jpg", alt: "Кейс 5" },
    { src: "/r6.jpg", alt: "Кейс 6" },
];
...
export default function CasesSection() {
    ...
    return (
        <section id='cases' className="w-full py-16 px-4 bg-gray-50">
            <div className="max-w-[1350px] sm:px-10 px-1 mx-auto text-center">
                <motion.h2
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                    ...
                    <p className="text-base font-normal mt-4 md:text-lg text-gray-600 max-w-2xl mx-auto">
                        Ниже скриншоты с результатами. Нажмите, чтобы увеличить.
                    </p>
                </motion.h2>
                    ...
                    {screenshots.map((shot, i) => (
                        ...
                        >
                            <Image
                                ...
                                width={400}
                                height={250}
                                className="rounded-xl shadow-md border border-gray-200 object-cover h-48 w-full"
                            />
                ...
                <AnimatePresence>
                    {selected !== null && (
                        ...
                        >
                            <motion.div
                                className="relative max-w-4xl w-[85%] max-h-[85%]"
                            ...
                            >
                                ...
                                />
                                <button
                                    className="absolute top-3 right-3 h-10 w-10 bg-white/60 rounded-full p-2 shadow-md hover:bg-gray-100"
                                    onClick={() => setSelected(null)}
                                >
                                    ✕
                                </button>
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.6, delay: 0.4 }}
                    viewport={{ once: true }}
                    className="mt-16 bg-white rounded-3xl shadow-md border border-gray-200 p-8"
                >
                    <h3 className="text-2xl font-bold mb-8">Общая статистика клиентов*</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
                        <div>
                    ...
                    <div className="mt-4 bg-emerald-50 text-emerald-700 text-sm font-medium px-4 py-2 rounded-lg inline-flex items-center gap-2">
                        Результаты основаны на реальных торговых данных
                    </div>
                </motion.div>
            </div>
